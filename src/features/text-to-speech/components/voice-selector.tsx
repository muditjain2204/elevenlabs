...
import { VoiceCategory } from "@/generated/prisma/client";
...
export function VoiceSelector() {
    ...
    // voiceId : 123
    const selectedVoices = voices.find((v) => v.id === voiceId);
    const hasMissingSelectedVoice = Boolean(voiceId) && !selectedVoices;
    const currentVoice = selectedVoices 
            ? selectedVoices 
