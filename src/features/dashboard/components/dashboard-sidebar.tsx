...
function NavSection ({
    ...
    return (
        <div>
            <SidebarGroup>
                {label && (
                    <SidebarGroupLabel className="text-[13px] uppercase text-mutes-foreground">
                        {label}
                    </SidebarGroupLabel>
                )}
                <SidebarGroupContent>
...
export function DashboardSidebar() {
    ...
    const otherMenuItems : MenuItem[] = [
        ...
        },
        {
            ...
            url: "mailto:business@codeWithmudit.com",
            icon : Headphones,
        },
    ];
            ...
            <SidebarHeader className="flex flex-col gap-4 pt-4">
                ...
                <SidebarMenu>
                    <SidebarMenuItem>
                            ...
                            fallback={
                                <Skeleton
                                className="h-8.5 w-full group-data-[collapsible=icon]:size-8
                            ...
                            appearance={{
                                elements:{
                                    rootBox:
                                        ...
                                        "w-full! justify-between! bg-white! border! border-border! rounded-md! pl-1! pr-2! py-1! gap-3! group-data-[cpllapsible=icon]:w-auto! group-data-[collapsible=icon]:p-1! data-[active=true]:shadow-[0px_1px_1px_0px_rgba(44,54,53,0.03),inset_0px_0px_0px_2px_white]",
